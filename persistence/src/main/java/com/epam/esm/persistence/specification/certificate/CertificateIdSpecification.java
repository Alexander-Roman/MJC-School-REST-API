...
public class CertificateIdSpecification implements Specification<Certificate> {
    ...
    private static final String SQL_FIND_BY_ID =
            "        SELECT certificate.id AS certificate_id, \n" +
                    ...
                    "WHERE certificate.certificate_id = :certificateId \n";

    private final Long certificateId;

    public CertificateIdSpecification(Long certificateId) {
